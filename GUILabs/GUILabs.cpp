// GUILabs.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGUILabsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

// создание CGUILabsApp

CGUILabsApp::CGUILabsApp()
{
...
// Единственный объект CGUILabsApp

CGUILabsApp theApp;

// инициализация CGUILabsApp

BOOL CGUILabsApp::InitInstance()
{
